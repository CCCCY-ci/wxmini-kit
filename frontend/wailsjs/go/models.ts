...
export namespace wechat {
	...
	export class WxapkgItem {
	    ...
	    UnpackRestoredFiles: number;
	    UnpackRestoreWarnings: number;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.UnpackRestoredFiles = source["UnpackRestoredFiles"];
	        this.UnpackRestoreWarnings = source["UnpackRestoreWarnings"];
	    }
	}
